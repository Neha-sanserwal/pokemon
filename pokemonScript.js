...
const handleSearch = function(){
  ...
  location.href = '#'+(searchBox.value).toLowerCase();
}

const addCards = function(){
  document.getElementsByClassName('spinnerBox')[0].style.display = 'none';
  document.getElementsByClassName('pokePage')[0].style.display = 'flex';
  const cards = []
  ...
  ${showEvoluation(monster.evolutions)}
    ...
    <div class='desc'>
        ...
        <span style='font-size: 13px; text-align: left;'>${monster.description}</span>
    </div>
  </div>`);
